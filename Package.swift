...
let version = "0.9.0-beta6"
let checksum = "2d3462e167ad4264665be40775606fb70717aabd7fbaeb19019751f7a1f6d515"
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/adison-ads/adison-offerwall-global-core", exact: "0.28.0-beta5")
    ],
    targets: [
        .binaryTarget(
            name: "AdisonOfferwallGlobalBase",
