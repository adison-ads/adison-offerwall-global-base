...
let checksum = "a3a11de9ec18a3418335c92406d14a793e4d3bb9ecf0a6c77a68452f91e8f45b"
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/adison-ads/adison-offerwall-global-core", exact: "0.28.0-beta1")
    ],
    targets: [
        .binaryTarget(
            name: "AdisonOfferwallGlobalBase",
